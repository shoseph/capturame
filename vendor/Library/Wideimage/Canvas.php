 ...
 * @copyright 2007-2011
    ...
    * @package WideImage
  **/
    namespace Library\Wideimage;
    use Library\Wideimage\WideImage_Exception;
    use Library\Wideimage\Font\WideImage_Font_GDF;
    use Library\Wideimage\Font\WideImage_Font_PS;
    use Library\Wideimage\Font\WideImage_Font_TTF;
	/**
	 * @package Exceptions
	 */
