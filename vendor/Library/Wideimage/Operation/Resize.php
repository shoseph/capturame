 ...
 * @copyright 2007-2011
  ...
  **/
    namespace Library\Wideimage\Operation;
    use Library\Wideimage\WideImage_Exception;
    use Library\Wideimage\WideImage_GDFunctionResultException;
    use Library\Wideimage\WideImage_Coordinate;
    use Library\Wideimage\WideImage_TrueColorImage;
    use Library\Wideimage\WideImage_PaletteImage;
