...
class FacebookVincularUsuarioHelper extends CapturaViewHelper
{
    protected $_config;
    protected $_form;
    ...
    public function __invoke ()
    {
        ...
        if ($this->_config['me']) {
        	...
        	$this->_config['loginUrl'] = $facebook->getLoginUrl(array('scope' => 'email, publish_actions, user_about_me', 'redirect_uri'=> "http://{$_SERVER['HTTP_HOST']}/vincular-facebook-capturame"));
        }  
        return $this->renderPartial('facebook-vincular-usuario', $this->_config, 'Application', 'Index');
    }
